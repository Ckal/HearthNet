...
class TestModelDistributionService:
    ...
    def test_advertise_empty_returns_empty_list(self, tmp_path):
        ...
        req = RouteRequest(
            capability="model.advertise", version_req=(1, 0), body={}, caller="test", trace_id="t"
        )
    ...
    def test_two_node_model_transfer(self, tmp_path):
        ...
        provider_svc = ModelDistributionService(store=provider_store, bus=provider_node.bus)
